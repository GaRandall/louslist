...
def home(request):
    ...
    for x in Dept.objects.all():
        ...
        for a in res:
            sub=Subject(a['instructor'],a['course_number'],a['semester_code'],a['course_section'],a['subject'],a['catalog_number'],a['description'],a['units'],a['component'],a['class_capacity'],a['wait_list'],a['wait_cap'],a['enrollment_total'],a['enrollment_available'],a['topic'],a['meetings'])
            sub.save()
    context = {
        'data': resp
    }
